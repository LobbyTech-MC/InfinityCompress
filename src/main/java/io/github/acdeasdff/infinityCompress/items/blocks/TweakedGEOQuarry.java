...
public final class TweakedGEOQuarry extends AbstractMachineBlock implements RecipeDisplayItem {
    ...
    public TweakedGEOQuarry(ItemGroup category, SlimefunItemStack item, RecipeType type, ItemStack[] recipe, int itemMultiplier) {
