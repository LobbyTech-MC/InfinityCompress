...
import static io.github.mooy1.infinityexpansion.items.generators.Generators.ADVANCED_PANEL;
import static io.github.mooy1.infinityexpansion.items.generators.Generators.BASIC_PANEL;
import static io.github.mooy1.infinityexpansion.items.generators.Generators.CELESTIAL_PANEL;
import static io.github.mooy1.infinityexpansion.items.generators.Generators.INFINITE_PANEL;
import static io.github.mooy1.infinityexpansion.items.generators.Generators.VOID_PANEL;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.ADVANCED_TREE;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.BASIC_COBBLE;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.DUST_EXTRACTOR;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.GEAR_TRANSFORMER;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.GEO_QUARRY;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.INFINITE_VOID_HARVESTER;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.INFINITY_COBBLE;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.INFINITY_DUST_EXTRACTOR;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.INFINITY_INGOT_FORMER;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.SINGULARITY_CONSTRUCTOR;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.STONEWORKS_FACTORY;
import static io.github.mooy1.infinityexpansion.items.machines.Machines.URANIUM_EXTRACTOR;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.ADAMANTITE;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.ALUMINUM_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.COAL_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.COBBLE_1;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.COBBLE_2;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.COBBLE_3;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.COBBLE_4;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.COBBLE_5;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.COPPER_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.DIAMOND_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.EARTH_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.EMERALD_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.ENDER_ESSENCE;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.FORTUNE_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.GOLD_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.INFINITE_CIRCUIT;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.INFINITE_INGOT;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.IRON_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.LAPIS_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.LEAD_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.MACHINE_CIRCUIT;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.MACHINE_CORE;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.MAGIC_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.MAGNESIUM_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.MAGNONIUM;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.MAGSTEEL;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.MAGSTEEL_PLATE;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.METAL_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.MYTHRIL;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.NETHERITE_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.QUARTZ_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.REDSTONE_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.SILVER_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.TIN_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.TITANIUM;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.VOID_DUST;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.VOID_INGOT;
import static io.github.mooy1.infinityexpansion.items.materials.Materials.ZINC_SINGULARITY;
import static io.github.mooy1.infinityexpansion.items.mobdata.MobData.CHAMBER;
import static io.github.mooy1.infinityexpansion.items.mobdata.MobData.ENDER_DRAGON;
import static io.github.mooy1.infinityexpansion.items.mobdata.MobData.WITHER;
import static io.github.mooy1.infinityexpansion.items.quarries.Quarries.INFINITY_QUARRY;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.ALUMINUM_BRASS_INGOT;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.ALUMINUM_BRONZE_INGOT;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.BATTERY;
...
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.BRASS_INGOT;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.BRONZE_INGOT;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.CARBON;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.CARBONADO;
...
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.CARBON_PRESS_3;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.CARGO_MOTOR;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.COBALT_INGOT;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.COMPRESSED_CARBON;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.CORINTHIAN_BRONZE_INGOT;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.CRAFTING_MOTOR;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.DAMASCUS_STEEL_INGOT;
...
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.HEATED_PRESSURE_CHAMBER_2;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.LARGE_CAPACITOR;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.MAGNET;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.MEDIUM_CAPACITOR;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.NICKEL_INGOT;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.OIL_PUMP;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.RAW_CARBONADO;
...
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.SILICON;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.SMALL_CAPACITOR;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.SOLAR_GENERATOR;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.SOLAR_GENERATOR_2;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.SOLAR_GENERATOR_3;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.SOLAR_GENERATOR_4;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.SOLAR_PANEL;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.SOLDER_INGOT;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.STEEL_INGOT;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.SYNTHETIC_DIAMOND;
import static io.github.thebusybiscuit.slimefun4.implementation.SlimefunItems.TRASH_CAN;
